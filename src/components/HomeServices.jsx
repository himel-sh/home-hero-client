            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  key={service._id}
                  variants={fadeInUp}
                  className="relative group bg-base-300 p-4 rounded-xl   shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col justify-between"
                >
                  {/* Icon */}
                  ...
                  <div className="mt-8">
                    ...
                    {/* Arrow + Read More (triggered by card hover) */}
